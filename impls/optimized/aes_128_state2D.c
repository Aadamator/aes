...
// Optimized GF(2) multiplication by 2
...
void aes_encrypt(uint8_t state[4][4], uint8_t roundKeys[11][4][4]) {
...
int main() {
    ...
    uint8_t state[4][4];
    uint8_t roundKeys[11][4][4] = {0}; 

    timer_t start, end;
    
    printf("Starting Task 2 Benchmark (%d iterations)...\n", ITERATIONS);
